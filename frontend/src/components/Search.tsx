...
export type Course = {
	...
	notes: string,
	"catalogue_data.description": string,
	"catalogue_data.learning_objectives": string,
	"catalogue_data.content"?: string,
	"catalogue_data.lecture_notes"?: string,
	"catalogue_data.literature"?: string,
	"catalogue_data.prerequisites"?: string,
