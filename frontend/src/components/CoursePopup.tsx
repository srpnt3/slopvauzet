...
function CoursePopup({course, setCoursePopup}: { course: Course, setCoursePopup: (course: Course | undefined) => void }) {
	...
	return (
		<div className="flex flex-col items-start absolute left-14 right-14 top-20 bottom-10 p-2 bg-bg1 overflow-hidden">
			...
			<div className="flex flex-col gap-12 overflow-y-scroll w-full">
